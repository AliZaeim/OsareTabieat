...
namespace DataLayer.Context
{
    ...
    public class MyContext : DbContext
    {
        ...
        public DbSet<BannerNextBase> BannerNextBases { get; set; }
        public DbSet<BannerNextSlider> BannerNextSliders { get; set; }
        public DbSet<PageBanner> PageBanners { get; set; }
        public DbSet<PageBannerItem> PageBannerItems { get; set; }
        public DbSet<SiteInfo> SiteInfos { get; set; }
        public DbSet<StateFreight> StateFreights { get; set; }
        public DbSet<FAQ> FAQs { get; set; }
        public DbSet<BestDeal> BestDeals { get; set; }
        public DbSet<UploadCenter> UploadCenters { get; set; }
        public DbSet<CellphonesBank> CellphonesBanks { get; set; }
        public DbSet<CustomerContact> CustomerContacts { get; set; }
        public DbSet<Term> Terms { get; set; }
        public DbSet<StorePageBanner> StorePageBanners { get; set; }
        #endregion
        #region Store
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<County>().HasQueryFilter(x => !x.IsDeleted);
            modelBuilder.Entity<Status>().HasQueryFilter(x => !x.IsDeleted);
            modelBuilder.Entity<Blog>().HasQueryFilter(x => !x.IsDeleted);
            modelBuilder.Entity<BlogGroup>().HasQueryFilter(x => !x.IsDeleted);
            ...
            modelBuilder.Entity<Status>().HasData(
                new Status() { Id = 1, Text = "تحویل به پست" },
                new Status() { Id = 2, Text = "تحویل به مشتری",IsEndofProccess = true },
                new Status() { Id = 3, Text = "انصراف", IsEndofProccess = true }
            );
            #endregion
            #region SiteInfo
            modelBuilder.Entity<SiteInfo>().HasData(
                ...
                {
                    Id = 1,
                    Address = "کرج، مهرشهر،ابتدای بلوار ارم، خیابان رسولی، نبش کوچه پیچک یک",
                    Phone1 = "02633302220",
                    Phone2 = "02633311872",
                    SiteCurrency = "ریال",
                    Mobile1 = "09128027423",
                    Mobile2 = "09104319418",
                    RegDate = DateTime.Now,
                    WorkTime = "هر روز هفته، از 10 صبح تا 10 شب",
                    MainPageMessage = ""
                }
                );
            #endregion SiteInfo
